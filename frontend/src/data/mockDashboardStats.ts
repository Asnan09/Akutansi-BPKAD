...
export const yearOptions = [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025, 2026, 2027, 2028, 2029, 2030, 2031, 2032, 2033, 2034, 2035];
...
export const uploadRecords: UploadRecord[] = [
  ...
  { id: 3, kategori: "BKU", uploadedAt: "2026-01-10" },
  ...
  { id: 7, kategori: "BKU", uploadedAt: "2026-03-02" },
  ...
  { id: 12, kategori: "BKU", uploadedAt: "2026-06-10" },
  ...
  { id: 16, kategori: "BKU", uploadedAt: "2026-09-01" },
  ...
  { id: 23, kategori: "BKU", uploadedAt: "2027-01-10" },
  ...
  { id: 27, kategori: "BKU", uploadedAt: "2027-03-02" },
  ...
  { id: 32, kategori: "BKU", uploadedAt: "2027-06-10" },
  ...
  { id: 36, kategori: "BKU", uploadedAt: "2027-09-01" },
