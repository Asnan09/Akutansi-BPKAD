        ...
        <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
          ...
          <div className="inline-block w-full max-w-lg my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-2xl rounded-2xl animate-[scaleIn_0.3s_ease-out]">
            ...
            <form onSubmit={handleSubmit} className="px-6 py-6 space-y-5">
              {/* Document Name */}
              <div className="group">
                <label htmlFor="edit-name" className="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wide">
                  Nama Dokumen
                </label>
              ...
              {/* Date */}
              <div className="group">
                <label htmlFor="edit-date" className="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wide">
                  Tanggal
                </label>
                <div className="relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-orange-600 rounded-xl opacity-0 group-hover:opacity-100 blur transition-opacity duration-300"></div>
              ...
              {/* Category */}
              <div className="group">
                <label htmlFor="edit-category" className="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wide">
                  Kategori
                </label>
                <div className="relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-orange-600 rounded-xl opacity-0 group-hover:opacity-100 blur transition-opacity duration-300"></div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-blue-800">
                    ...
                    <p className="text-xs">Format: <span className="font-semibold">{document.format}</span></p>
                    <p className="text-xs">Ukuran: <span className="font-semibold">{document.size}</span></p>
                  </div>
                </div>
              </div>
