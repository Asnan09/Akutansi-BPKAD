...
export default function LoginForm({
  ...
  return (
    <div className="w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-8 py-8 lg:py-0 order-1 animate-[slideInLeft_0.6s_ease-out]">
      <div className="w-full max-w-[460px] bg-white dark:bg-slate-900/95 rounded-3xl shadow-2xl shadow-orange-500/10 px-6 sm:px-12 py-10 sm:py-14 border border-orange-100/50 dark:border-slate-700/70 backdrop-blur-sm animate-[fadeIn_0.8s_ease-out_0.2s_both]">
